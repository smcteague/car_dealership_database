...
CREATE TABLE "service_ticket" (
  ...
  CONSTRAINT "FK_service_ticket.service_ticket_id"
    FOREIGN KEY ("service_ticket_id")
      REFERENCES "service_history"("service_ticket_id")
);
...
CREATE TABLE "service_parts" (
  ...
  CONSTRAINT "FK_service_parts.service_ticket_id"
    FOREIGN KEY ("service_ticket_id")
      REFERENCES "service_ticket"("service_ticket_id"),
  CONSTRAINT "FK_service_parts.service_id"
    FOREIGN KEY ("service_id")
      REFERENCES "services"("service_id"),
  CONSTRAINT "FK_service_parts.parts_id"
...
CREATE TABLE "service_mechanics" (
  ...
  CONSTRAINT "FK_service_mechanics.service_ticket_id"
    FOREIGN KEY ("service_ticket_id")
      REFERENCES "service_ticket"("service_ticket_id"),
  CONSTRAINT "FK_service_mechanics.mechanic_id"
